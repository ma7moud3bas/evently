    ...
    return (
        <header className="w-full px-5 py-2 flex justify-between items-center bg-gray-800 border-b border-primary-700"  {...rest}>
            <div className="brand flex justify-between items-center gap-x-12">
                ...
                <Image onClick={() => setSidebarOpen(!sidebarOpen)} className={`cursor-pointer max-md:hidden ${sidebarOpen ? "" : "rotate-180"}`} src="/assets/images/chevron-circle-left.svg" width="24" height="24" alt="arrow left"></Image>
            </div>
